...
##  创建配置分发器类
  继承`AbstractAnnotationConfigDispatcherServletInitializer`，初始化springMVC配置
...
## 创建jsp前端页面
  ...
  ```
## 配置tomcat服务器
    选中工程右键->Run On Server

## 地址栏输入地址测试
    http://localhost:8080/cn.runfeng.HadoopTrain/home 测试成功
